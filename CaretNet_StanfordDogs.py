...
def get_args():
    ...
    """
    parser = argparse.ArgumentParser(description='CaretNet training script for CIFAR and fine-grained datasets.', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
def main():
    ...
    if args.evaluate:
        pathcheckpoint = "./checkpoints/StanfordDogs/checkpoint6576.pth"
